...
TriggerObjectAnalyzer::TriggerObjectAnalyzer(const edm::ParameterSet& ps):
  ...
  sl1name(ps.getUntrackedParameter<string>("triggerL1Name"))
{
  ...
  tree_->Branch("l1_doubleEG2_notHF2_pt",      &l1_doubleEG2_notHF2_pt_);
  tree_->Branch("l1_doubleEG2_notHF2_eta",     &l1_doubleEG2_notHF2_eta_);
  tree_->Branch("l1_doubleEG2_notHF2_phi",     &l1_doubleEG2_phi_);
  tree_->Branch("l1_singleEG5_notHF2_pt",      &l1_singleEG5_notHF2_pt_);
  tree_->Branch("l1_singleEG5_notHF2_eta",     &l1_singleEG5_notHF2_eta_);
  tree_->Branch("l1_singleEG5_notHF2_phi",     &l1_singleEG5_notHF2_phi_);  
  ...
  if(hltConfig_.size() > 0){
   ...
   for(unsigned int itrig=0; itrig<triggerNames_.size(); itrig++){
	...
	//    moduleLabel = trigFilterIndex.at(l); 
        //    cout <<" modulelabel: " << moduleLabel << " sl1:" << sl1name << endl;
	//    if(moduleLabel.find(sl1name) != std::string::npos) cout << " L1 TRUE " << endl;
       // }
