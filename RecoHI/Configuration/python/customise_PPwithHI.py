...
def storeCaloTowersAOD(process):
    ...
    if hasattr(process,'AODoutput'):
        ...
        process.AODoutput.outputCommands.extend(['keep *_mix_MergedTrackTruth_*'])
        process.AODoutput.outputCommands.extend(['keep *_siPixelRecHits_*_*'])
        process.AODoutput.outputCommands.extend(['keep *_siPixelClusters_*_*'])
    if hasattr(process,'AODSIMoutput'):
        process.AODSIMoutput.outputCommands.extend(['keep *_towerMaker_*_*'])
        process.AODSIMoutput.outputCommands.extend(['keep *_mix_MergedTrackTruth_*'])

    
    if hasattr(process,'RECOoutput'):
        process.RECOoutput.outputCommands.extend(['keep *_towerMaker_*_*'])
        process.RECOoutput.outputCommands.extend(['keep *_siPixelRecHits_*_*'])
        #process.RECOoutput.outputCommands.extend(['keep *_mergedtruth_*_*'])
        process.RECOoutput.outputCommands.extend(['keep *_MergedTrackTruth_*_*'])
        process.RECOoutput.outputCommands.extend(['keep *_mix_*_*'])
