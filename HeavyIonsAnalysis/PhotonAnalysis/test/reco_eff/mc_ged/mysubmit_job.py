...
for x in files:
    with open('closure'+x+'.csh', 'w') as fout:
        fout.write("#!/bin/tcsh\n")
        fout.write("setenv HOME /afs/cern.ch/work/r/rchudasa/private/CMSSW_7_5_8_patch4/src/HeavyIonsAnalysis/PhotonAnalysis/test/aug_reco_data_check_for_lumi/hiforest/reco_eff/mc_ged\n")
        ...
        fout.write("cp test.root /afs/cern.ch/work/r/rchudasa/private/CMSSW_7_5_8_patch4/src/HeavyIonsAnalysis/PhotonAnalysis/test/aug_reco_data_check_for_lumi/hiforest/reco_eff/mc_ged"+"/ntuple"+x+".root\n")
        #fout.write("cp test.root $PWD"+"/ntuple"+x+".root\n")
        fout.write("cp "+macro+".C /afs/cern.ch/work/r/rchudasa/private/CMSSW_7_5_8_patch4/src/HeavyIonsAnalysis/PhotonAnalysis/test/aug_reco_data_check_for_lumi/hiforest/reco_eff/mc_ged"+"/"+macro+".C\n")      
