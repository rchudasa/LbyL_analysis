...
photonIsolationHIProducer::produce(edm::Event& evt, const edm::EventSetup& es)
{
  ...
  for (reco::PhotonCollection::const_iterator phoItr = photons->begin(); phoItr != photons->end(); ++phoItr)
  {
    ...
    iso.trackIsoR1PtCut20(TxC.getBkgSubTrackIso(*phoItr,1,0));
    iso.trackIsoR2PtCut20(TxC.getBkgSubTrackIso(*phoItr,2,0));
    iso.trackIsoR3PtCut20(TxC.getBkgSubTrackIso(*phoItr,3,0));
    iso.trackIsoR4PtCut20(TxC.getBkgSubTrackIso(*phoItr,4,0));
    iso.trackIsoR5PtCut20(TxC.getBkgSubTrackIso(*phoItr,5,0));
