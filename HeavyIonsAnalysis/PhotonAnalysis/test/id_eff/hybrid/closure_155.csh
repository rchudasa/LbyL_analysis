...
cp filelist_155.txt ${WORK}
cd ${WORK}
g++ check_data_driven_id_eff.C `root-config --cflags --libs` -O2 -o check_data_driven_id_eff.exe
./check_data_driven_id_eff.exe "filelist_155.txt" 
cp test.root /afs/cern.ch/work/r/rchudasa/private/CMSSW_7_5_8_patch4/src/HeavyIonsAnalysis/PhotonAnalysis/test/aug_reco_data_check_for_lumi/hiforest/id_eff/hybrid/ntuple_155.root
